...
subprocess.check_output(["aws", "s3", "cp", f"s3://Fine-Tune-SciBERT/{github_username}/mlflow/", str(MODEL_REGISTRY), "--recursive"])
subprocess.check_output(["aws", "s3", "cp", f"s3://Fine-Tune-SciBERT/{github_username}/results/", "./", "--recursive"])
